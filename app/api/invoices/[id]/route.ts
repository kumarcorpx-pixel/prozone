...
export async function PUT(
  ...
  try {
    ...
    if (action === "pdf") {
      ...
      ${termsText ? `<div class="terms"><strong>Terms:</strong><br>${termsText}</div>` : ""}
      ${notesText ? `<div class="terms"><strong>Notes:</strong><br>${notesText}</div>` : ""}
